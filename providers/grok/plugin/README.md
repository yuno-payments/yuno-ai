...
Grok plugin that helps you build and test a [Yuno](https://y.uno) integration
...
1. Open your Grok plugin settings.
2. Search for **Yuno**.
3. Install it, then complete the Yuno sign-in prompt.
...
Auth is OAuth 2.1 with Dynamic Client Registration and PKCE (`S256`). The client
